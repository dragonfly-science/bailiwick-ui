...
/*!***********************************************!*\
  !*** ./js-src/charts/indicator-timeseries.js ***!
  \***********************************************/
/*! exports provided: updateIndicatorTimeSeries */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "updateIndicatorTimeSeries", function() { return updateIndicatorTimeSeries; });
...
var updateIndicatorTimeSeries = function updateIndicatorTimeSeries(element, params) {
  ...
  var g = svg.selectAll('g').data([data]),
      gEnter = g.enter().append("g").attr("transform", "translate(" + margin.left + "," + margin.top + ")");

  var years = lodash__WEBPACK_IMPORTED_MODULE_1___default.a.uniq(lodash__WEBPACK_IMPORTED_MODULE_1___default.a.reduce(data, function (result, value, key) {
  ...
  gEnter.append("line").attr("x1", lineXpos).attr("y1", 0).attr("x2", lineXpos).attr("y2", clipHeight).attr("stroke-width", 1).attr("stroke", "rgba(0,0,0,.5)").attr("z", 100).attr("class", "year-line");
  /*
  ...
  gEnter.append("clipPath").attr("id", "clipper").append("rect").attr("x", 0).attr("y", 0).attr("width", clipWidth).attr("height", clipHeight);
  svg.selectAll(".axis--x .tick").on("click", function (d) {
    var year = new Date(d).getFullYear();
    console.log(year); // let filter = _this.get('bailiwick.indicator').get('years').filter(function (y) {
  ...
  g.selectAll('g.areas').selectAll('path').attr("class", function (d) {
    ...
    return className; // } else if (d.name === compareAreaName) {
    //     return "compare-area";
  ...
  var vg = voronoiGroup.selectAll("path").data(voronoi(d3__WEBPACK_IMPORTED_MODULE_0___default.a.nest().key(function (d) {
    ...
    var year = new Date(d.date).getFullYear(),
        area = d.area.slug;
    console.log(year, d); // let filter = _this.get('bailiwick.indicator').get('years').filter(function (y) {
  ...
  legendTexts.exit().remove(); // this.$().removeClass("svg-loading");
};
...
var getColours = function getColours() {
  ...
  lodash__WEBPACK_IMPORTED_MODULE_0___default.a.each(colorChildren, function (value, i) {
