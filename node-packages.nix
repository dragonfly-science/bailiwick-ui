...
let
  sources = {
    ...
    "cache-2.1.0" = {
      ...
      version = "2.1.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/cache/-/cache-2.1.0.tgz";
        sha1 = "ec970ce99a3d1f12e191e0abb02dedc71d2743c8";
      };
    };
    "cache-base-1.0.1" = {
      name = "cache-base";
    ...
    "chroma-js-2.0.3" = {
      ...
      version = "2.0.3";
      src = fetchurl {
        url = "https://registry.npmjs.org/chroma-js/-/chroma-js-2.0.3.tgz";
        sha512 = "2kTvZZOFSV1O81/rm99t9vmkh9jQxsHqsRRoZevDVz/VCC3yKMyPuMK8M5yHG+UMg2tV6cRoqtZtgcD92udcBw==";
      };
    };
    ...
    "d3-3.5.12" = {
      ...
      version = "3.5.12";
      src = fetchurl {
        url = "https://registry.npmjs.org/d3/-/d3-3.5.12.tgz";
        sha1 = "3b821f5b72c5371eccea1aaf4da2f317eb473240";
      };
    };
    "date-now-0.1.4" = {
      name = "date-now";
    ...
    "electron-to-chromium-1.3.155" = {
      ...
      version = "1.3.155";
      src = fetchurl {
        url = "https://registry.npmjs.org/electron-to-chromium/-/electron-to-chromium-1.3.155.tgz";
        sha512 = "/ci/XgZG8jkLYOgOe3mpJY1onxPPTDY17y7scldhnSjjZqV6VvREG/LvwhRuV7BJbnENFfuDWZkSqlTh4x9ZjQ==";
      };
    };
    "elliptic-6.4.1" = {
      name = "elliptic";
    ...
    "rgb-hex-3.0.0" = {
      ...
      version = "3.0.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/rgb-hex/-/rgb-hex-3.0.0.tgz";
        sha512 = "8h7ZcwxCBDKvchSWbWngJuSCqJGQ6nDuLLg+QcRyQDbX9jMWt+PpPeXAhSla0GOooEomk3lCprUpGkMdsLjKyg==";
      };
    };
    "rimraf-2.6.3" = {
      name = "rimraf";
    ...
    "webpack-cli-3.3.3" = {
      ...
      version = "3.3.3";
      src = fetchurl {
        url = "https://registry.npmjs.org/webpack-cli/-/webpack-cli-3.3.3.tgz";
        sha512 = "/qBxTvsxZ7bIFQtSa08QRY5BZuiJb27cbJM/nzmgXg9NEaudP20D7BruKKIuWfABqWoMEJQcNYYq/OxxSbPHlg==";
      };
    };
  ...
  args = {
    ...
    dependencies = [
      ...
      sources."electron-to-chromium-1.3.155"
